...
function PointSaverPrivacyPolicyPage(): JSX.Element {
    return (
        <Page>
            <Heading>Point Saver Privacy Policy</Heading>
            <Paragraph>
...
export default PointSaverPrivacyPolicyPage;

export const Head: HeadFC = () => <title>PointSaver Privacy Policy</title>;
