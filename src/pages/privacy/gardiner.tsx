...
function GardinerPrivacyPolicyPage(): JSX.Element {
    return (
        <Page>
            <Heading>Gardiner’s List Privacy Policy</Heading>
            <Paragraph>
...
export default GardinerPrivacyPolicyPage;

export const Head: HeadFC = () => <title>Gardiner’s List Privacy Policy</title>;
